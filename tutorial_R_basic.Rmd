...
Let's assume that you have R and Rstudio installed on your computer, launch Rstudio and you should be able to see the Rstudio window:  
...
`dplyr` is a R package that is being widely used for data manipulation.
