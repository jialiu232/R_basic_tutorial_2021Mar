...
Most of the times, you can find help about the function/package that you are interested in from its documentation or online resources. But if your work needs some specific functions or the same chunk of code is reused multiple times, it's always a good idea to write your own functions or even packages!
...
The structure of a R function is shown below:
...
Now we can temperature in Fahrenheit to Celsius with `f_to_c`. For example, temperature of 100 in Fahrenheit is:
...
See these resources of [creating functions](https://swcarpentry.github.io/r-novice-inflammation/02-func-R/) and 
