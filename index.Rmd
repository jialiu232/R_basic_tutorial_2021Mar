...
Learning a new language is cool! But learning the basic stuff of a language can sometimes be just **a little bit** dry (Oops). While typing `print("Hello World")` or some small basic chunks, we probably think: why am I learning this thing? where am I in the big R knowledge field? when can I do fancy things?     
